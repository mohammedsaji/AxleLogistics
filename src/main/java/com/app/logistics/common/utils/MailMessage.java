...
public class MailMessage {
            ...
            <div style="max-width:640px;margin:40px auto;padding:0 20px;">
                ...
                <div style="border:1px solid #d0d7de;border-radius:6px;padding:30px;">
                    ...
                    <p style="font-size:16px;line-height:1.6;">
                        We received a request to reset your Passage Logistic Systems
                        account password.
                    </p>
                    ...
                    <div style="text-align:center;margin:30px 0;">
                        <a href="http://localhost:8080/views/reset-password/reset-password.html"
    ...
    final String shipmentTrackingIdContent ="";

    public String getResetPasswordContent() {
        return resetPasswordContent;
    }

    public String getShipmentTrackingIdContent() {
        return shipmentTrackingIdContent;
    }
}
