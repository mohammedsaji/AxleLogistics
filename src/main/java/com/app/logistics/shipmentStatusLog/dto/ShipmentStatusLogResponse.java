...
public class ShipmentStatusLogResponse {
    ...
    public String getAssignedByManagerName() {
        return assignedByManagerName;
    }

    public void setAssignedByManagerName(String assignedByManagerName) {
        this.assignedByManagerName = assignedByManagerName;
    }
}